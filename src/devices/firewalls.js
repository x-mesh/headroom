...
export const firewallCatalog = Object.freeze([
  ...
  },
  {
    ...
    profiles: [
      ...
      inspectionProfile('threat-prevention', '위협 방지 켬', 7.5e9,
        'App-ID, IPS, 안티바이러스, 안티스파이웨어, WildFire, 파일 차단, 로깅을 모두 켠 appmix 기준입니다.'),
    ],
  },
  {
    id: 'paloalto-pa-3440',
  ...
  },
  {
    ...
    profiles: [
      ...
      inspectionProfile('ftd-avc-ips', 'FTD · AVC + IPS', 10e9, '1024바이트 기준. 이 표에서는 AVC 단독과 같은 처리량으로 적혀 있습니다.'),
    ],
  },
  {
    ...
    profiles: [
      ...
      inspectionProfile('asa-multiprotocol', 'ASA · 멀티프로토콜', 43e9, '단일 프로토콜이 아닌 혼합 트래픽 기준입니다.'),
    ],
  },
]);
