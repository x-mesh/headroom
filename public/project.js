...
function validateDrawioVisual(visual) {
  ...
  if (visual.drawioOptions != null && (!plainObject(visual.drawioOptions) || Object.keys(visual.drawioOptions).some((key) => !['dashed', 'startArrow', 'endArrow', 'startFill', 'endFill', 'startSize', 'endSize', 'flipH', 'flipV', 'fixedAspect', 'rotation', 'resIcon', 'prIcon', 'grIcon', 'grIconSize', 'grStroke', 'size', 'dx', 'dy', 'notch', 'entryX', 'entryY', 'exitX', 'exitY', 'entryDx', 'entryDy', 'exitDx', 'exitDy', 'entryPerimeter', 'exitPerimeter', 'targetPerimeterSpacing', 'routeMode', 'elbow', 'jettySize', 'jumpStyle', 'jumpSize', 'dashPattern', 'fontFamily', 'textDirection', 'labelBackgroundColor', 'gradientDirection', 'verticalLabelPosition', 'spacingLeft', 'spacingRight', 'spacingTop', 'spacingBottom', 'autosize'].includes(key)))) throw new Error('Device drawio visual options are invalid');
