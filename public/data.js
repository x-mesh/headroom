...
export const demoTopology = {
  ...
  devices: [
    device('edge-a', 'EDGE A', 'router', 'EDGE', 110, 115, 'Cisco', 'DEMO-RTR-10G', { forwarding_bps: 10e9, forwarding_pps: 2.4e6 }, { powerBasis: 'typical', typicalDrawWatts: 140, uHeight: 1 }),
    device('edge-b', 'EDGE B', 'router', 'EDGE', 110, 430, 'Cisco', 'DEMO-RTR-10G', { forwarding_bps: 10e9, forwarding_pps: 2.4e6 }, { powerBasis: 'typical', typicalDrawWatts: 140, uHeight: 1 }),
    ...
    device('spine-a', 'SPINE A', 'switch', 'FABRIC', 490, 175, 'Juniper Networks', 'DEMO-SPN-20G', { forwarding_bps: 20e9, forwarding_pps: 3.2e6 }, { powerBasis: 'typical', typicalDrawWatts: 210, uHeight: 1 }),
    device('spine-b', 'SPINE B', 'switch', 'FABRIC', 490, 405, 'Juniper Networks', 'DEMO-SPN-20G', { forwarding_bps: 20e9, forwarding_pps: 3.2e6 }, { powerBasis: 'typical', typicalDrawWatts: 210, uHeight: 1 }),
